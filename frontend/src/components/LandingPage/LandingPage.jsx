        ...
        items-center min-h-screen">
                        ...
                        <div className="lg:w-3/4 xl:w-2/4 relative z-10 h-100 lg:mt-16">
                            <div>
                                ...
                                <p className="text-blue-100 text-left text-xl md:text-2xl leading-snug mt-4">Experience a new level of convenience and control over your healthcare with our AI-Health Management System.</p>
                ...
                <h1 className="text-3xl text-center pt-0 lg:py-12 leading-tight font-bold mt-4">Features</h1>
                    <div className="flex flex-col lg:flex-row lg:-mx-8">
                        <div className="w-full lg:w-1/2 lg:px-8">
                            <h2 className="text-2xl leading-tight font-bold mt-4">Welcome to our AI-Health Management System</h2>
                        ...
                        <div className="w-full lg:w-1/2 lg:px-8 mt-12 lg:mt-0">
                            ...
                            <div className="md:flex mt-8">
                                ...
                                <div className="md:ml-8 mt-4 md:mt-0">
                                    ...
                                    <p className="mt-2 leading-relaxed">Whether you're managing a chronic condition, preparing for a routine check-up, or just looking to stay on top of your health, our AI-Health Management System is here to help. Sign up today to start taking control of your health!</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="md:w-1/2 md:px-4 mt-4 md:mt-0 lg:w-1/4">
                            <div className="bg-white rounded-lg border border-gray-300 p-8">
                                ...
                                <p className="mt-1 text-justify">The AI-Health Management System includes an online payment system through RozarPay API that allows insurance companies to pay hospital bills directly.</p>
                            </div>
                        </div>
                        <div className="md:w-1/2 md:px-4 mt-4 md:mt-0 lg:w-1/4">
                            <div className="bg-white rounded-lg border border-gray-300 p-8">
                ...
                <section className="relative bg-blue-teal-gradient px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 text-center md:text-left">
                    <div className="md:flex md:items-center md:justify-center">
                        <h2 className="text-xl font-bold text-white">Get in touch with us today! <br className="block md:hidden" />Call us on: +91-9711136020</h2>
                ...
                <footer className="relative text-left bg-gray-900 text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 lg:py-24">
                    <div className="flex flex-col md:flex-row">
                        <div className="w-full lg:w-2/6 lg:mx-4 lg:pr-8">
                            <h3 className="font-bold text-2xl">AI-Health Management System</h3>
                            <p className="text-gray-400">Revolutionize your healthcare experience with our cutting-edge AI-health management system.</p>
                        ...
                        <div className="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
                            ...
                            <ul className="mt-4">
                                <li className="mt-2"><a href="#"  className="opacity-75 hover:opacity-100">General Medicine</a></li>
                                <li className="mt-2"><a href="#"  className="opacity-75 hover:opacity-100">Dermatologists</a></li>
                                <li className="mt-2"><a href="#"  className="opacity-75 hover:opacity-100">Cardiologistsh</a></li>
                                <li className="mt-2"><a href="#"  className="opacity-75 hover:opacity-100">Gynaecologist</a></li>
                            </ul>
                        </div>
                        ...
                        <div className="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
                            ...
                            <p className="text-sm text-gray-400 mt-12">© 2024 AI-Health Management System. <br className="hidden lg:block" />All Rights Reserved.
                            </p>
                        </div>
                    </div>
                </footer>
